...
const form = useForm({
    name: props.page_data.permission.name,
    description: props.page_data.permission.description || '',
    permission_group_id: props.page_data.permission.permission_group_id?.toString() || '',
});
